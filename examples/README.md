...
| `bfcl_grpo_apatch_observation_required_llama31_8b.yaml` | Observation-interface setting with `meta-llama/Llama-3.1-8B-Instruct`. |
| `bfcl_grpo_apatch_observation_required_toolace2_llama31_8b.yaml` | Observation-interface setting with `Team-ACE/ToolACE-2-Llama-3.1-8B`. |
| `bfcl_grpo_apatch_observation_required_watt_tool_8b.yaml` | Observation-interface setting with `watt-ai/watt-tool-8B`. |
