...
TRAIN_TASKS_FILE="$PROJECT_DIR/games/games/diplomacy/train_tasks.parquet"
...
python3 -m agentevolver.main_ppo \
    ...
    --config-name='config' \
    trainer.experiment_name="diplomacy_qwen3-8b_train" \
    ...
    trainer.validation_data_dir="experiments/diplomacy/diplomacy_qwen3-8b_train/validation_log" \
    trainer.rollout_data_dir="experiments/diplomacy/diplomacy_qwen3-8b_train/rollout_log" \
